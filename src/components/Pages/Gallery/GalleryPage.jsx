          ...
          <Grid item key={item.id} xs={12} sm={6} md={4} lg={3}>
            <Paper elevation={0}>
              ...
              <div style={{ paddingLeft: "22px" }}>
                ...
                <Typography variant="h6">by {item.user_name}</Typography>

                <Typography variant="p" style={{ paddingRight: "10px" }}>
                  {item.description}
                </Typography>
              </div>
            </Paper>
